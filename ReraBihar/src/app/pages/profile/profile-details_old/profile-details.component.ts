...
export class ProfileDetailsComponent implements OnInit {
    ...
    insertDataFromAadhaar(step: any, groupid: any, objData: any, grouppos: number = -1) {
        let fieldValue = [];
        if (groupid == 0 || groupid == null) {
            for (const obj of this.formDetails[step]) {
                if (obj.fielddetails.fielddesc === "Name_of_Proprietor") {
                    obj.fielddetails.fieldvalue = this.aadhaarData.full_name
                    fieldValue.push({'id':obj.fielddetails.fieldid,'val':obj.fielddetails.fieldvalue})
                }
                ...
                if (obj.fielddetails.fielddesc === "State") {
                ...
                for (let i = 0; i < fieldValue.length; i++) {
                    ...
                    //     stepid: 9,
                    //     fieldid: fieldValue[i].['id'],
                    //     fieldvalue: fieldValue[i].['val'],
                    //     isverified: 0
                    //   }
            ...
            for (let i = 0; i < objData.fielddetailskeys[grouppos].length; i++) {
                ...
                // if(objData.fielddetailskeys[grouppos][i] === "State"){
                //     objData.fielddetails[grouppos][objData.fielddetailskeys[grouppos][i]][0].fieldvalue = this.aadhaarData.state
                // }
                // if(objData.fielddetailskeys[grouppos][i] === "District"){
                //     objData.fielddetails[grouppos][objData.fielddetailskeys[grouppos][i]][0].fieldvalue = this.aadhaarData.dist
                // }
