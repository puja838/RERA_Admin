...
@Component({
  selector: 'app-significant-judgement',
  templateUrl: './significant-judgement.component.html',
  styleUrls: ['./significant-judgement.component.css']
})
export class SignificantJudgementComponent implements OnInit {
