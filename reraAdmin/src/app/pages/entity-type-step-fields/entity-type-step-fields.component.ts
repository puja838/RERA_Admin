...
import {EntityTypeStepFieldsService} from "../../services/entity-type-step-fields.service";
import {NotifierService} from "angular-notifier";
import { IDropdownSettings } from 'ng-multiselect-dropdown';

@Component({
  selector: 'app-entity-type-step-fields',
  templateUrl: './entity-type-step-fields.component.html',
  styleUrls: ['./entity-type-step-fields.component.css']
})
export class EntityTypeStepFieldsComponent implements OnInit {
  entityList: any = [];
  entityTypeList: any = [];
  fieldsList: any = [];
  groupList: any = [];
  ...
  constructor(private modalService: NgbModal, private apiService: EntityTypeStepFieldsService, private common: CommonService,
  ...
  addItem(): void {
    this.selectedFields.push({
      ...
      isRequired: false,
      isApproval: false,
      sequence: this.selectedFields.length + 1,
      width: 0,
      size: 0,
      rowname: '',
      parentFieldId: '',
