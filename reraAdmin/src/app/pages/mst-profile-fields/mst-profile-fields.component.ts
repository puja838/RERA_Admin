...
@Component({
  selector: 'app-mst-profile-fields',
  templateUrl: './mst-profile-fields.component.html',
  styleUrls: ['./mst-profile-fields.component.css']
})
export class MstProfileFieldsComponent implements OnInit {
  ...
  edit(obj: any, pos: number): void {
    ...
    this.businessunittypecode = obj.businessunittypecode;
    this.isUnique = obj.isuniqueid == '1';
    this.openModal(1);
  }
