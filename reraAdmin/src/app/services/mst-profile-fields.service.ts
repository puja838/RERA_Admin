...
export class MstProfileFieldsService {
    ...
    addData(data: any): any {
        return this.http.post(this.API_ROOT + 'v1/mst-profile-fields/add', JSON.stringify(data), httpOptions);
    }

    updateData(data: any): any {
        return this.http.post(this.API_ROOT + 'v1/mst-profile-fields/update', JSON.stringify(data), httpOptions);
    }

    deleteData(data: any): any {
        return this.http.post(this.API_ROOT + 'v1/mst-profile-fields/delete', JSON.stringify(data), httpOptions);
    }
